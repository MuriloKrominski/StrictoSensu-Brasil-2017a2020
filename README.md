...
cnpj,identificador_de_socio,nome_socio,cnpj_cpf_do_socio,codigo_qualificacao_socio,percentual_capital_social,data_entrada_sociedade,cpf_representante_legal,nome_representante_legal,codigo_qualificacao_representante_legal
...
cnae_secundaria.csv.gz
https://data.brasil.io/dataset/socios-brasil/cnae_secundaria.csv.gz

holding.csv
507.551 de registros
holding_cnpj,holding_razao_social,cnpj,razao_social,codigo_qualificacao_socia,qualificacao_socia
